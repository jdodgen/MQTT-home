<<<<<<< HEAD:micropython/notify when power changes/src/generator_power/run.py
...
try:
    ...
    client.close()
print("example exiting")
>>>>>>> d9f002c39b155164eca4e5cbc7f153f79d6eb90a:micropython/power_change_notifier/src/generator_power/run.py
