...
make_lids("UUUUUU", chars_per_row=5);
...
shell_z = usb_c_hole_height+shell_wall_thickness*2;
...
module make_s2_base() {
    difference()
    {
        ...
        translate([s2_x+0.5, (shell_y-usb_c_hole_width)/2, shell_z/2-usb_c_hole_height/2])
            usb_c_hole();
        hole_d = 4;
        translate([shell_x-shell_wall_thickness-(hole_d/2)-2,0, shell_z/2-0.4])
