...
<body>
  <table style="border: none;">
    <tr style="border: none;">
        <td style="border: none;"><h1  style="font-size: 40px;">XXXXXXXX home-broker:&nbsp&nbsp</h1></td>

        <td style="border: none;"><h2>xxxxxxxxxxxxxxxxxxxxxxDevice and WeMo/fauxmo Management</h2></td>
    </tr>
  </table>
  <table>
    <tr>
          ...
          <table class="leftright">
            <tr>
              <th>
                ...
                <button type="submit" name=action value="restart">Restart FauxMo Process</button><br>
